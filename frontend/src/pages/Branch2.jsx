...
import { MapPin, Dumbbell, User, Star, Calendar, Clock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-4">
            {branch2Data.name} <span className="text-red-600">Branch</span>
          </h1>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Advanced training equipment for serious athletes and fitness enthusiasts
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {branch2Data.equipment.map((item) => (
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Expert coaches with specialized training in advanced fitness techniques
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {branch2Data.trainers.map((trainer) => (
        ...
        {/* Classes Section - Unique to Branch 2 */}
        <section className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-black mb-4">
              <Calendar className="inline-block h-8 w-8 text-red-600 mr-2" />
              Group Classes Schedule
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Join our energetic group classes led by certified instructors
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {branch2Data.classes.map((classItem) => (
              <Card key={classItem.id} className="hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
                <CardHeader>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-600">Instructor: {classItem.instructor}</span>
                  </div>
                  <div className="mt-4">
        ...
        <section>
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Located in a peaceful suburban area with plenty of parking space
            </p>
          </div>
            ...
            <CardContent className="p-0">
              <div className="h-96 bg-gray-200 rounded-lg flex items-center justify-center">
                <div className="text-center text-gray-600">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Branch 2 Location</h3>
                  <p className="max-w-md mx-auto">{branch2Data.mapPlaceholder}</p>
                  <div className="mt-4 space-y-2">
                    <p className="font-medium">{branch2Data.name}</p>
                    <p className="text-sm">{branch2Data.address}</p>
                  </div>
                </div>
              </div>
            </CardContent>
